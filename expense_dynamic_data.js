    ...
    sections: [
        {
            ...
            rows: [
				...
				["DOLO", "February 28, 2024", "February 29, 2024", "Dr. Best", "$20.00"]
            ]
        },
        {
...
function buildDynamicDocument() {
    // Generate dynamic date and set it
    const dynamicDate = getFormattedCurrentDate();
    ...
    document.getElementById('claim-number-display').textContent = reportData.claimNumber;
    document.getElementById('requester-name-display').textContent = reportData.requesterName;
    document.getElementById('worker-app-id-1').textContent = reportData.workerAppId;
    document.getElementById('worker-app-id-2').textContent = reportData.workerAppId;
...
// Execute on load
document.addEventListener('DOMContentLoaded', buildDynamicDocument);
